...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/api/login","method":"post","propertyName":"accessToken"},"logout":false,"user":{"url":"/api/user","method":"get","propertyName":"user"}},"_name":"local"}))
